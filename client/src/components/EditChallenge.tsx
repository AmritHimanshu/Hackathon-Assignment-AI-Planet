    ...
    return (
        <div className='relative'>
            ...
            <form className='px-7 py-6 lg:px-20 lg:py-10'>
                ...
                <button className='bg-green-700 text-white text-[17px] font-semibold px-3 lg:px-5 py-2 lg:py-3 mt-6 lg:mt-10 rounded-md' onClick={handleOnSubmit} >{isLoading && <AutorenewIcon className='animate-spin' />} Save Challenge</button>
            </form>
        </div>
    )
}
